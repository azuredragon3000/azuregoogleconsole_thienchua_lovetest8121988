...
public class TruyenPhatGiaoDB extends SQLiteOpenHelper {
    ...
    public static final String DB_PATH = "/data/data/com.myapp.snackgame/databases/";
    public static final String DATABASE_NAME = "db_thien_chua.db";
    ...
    public ArrayList<ItemTruyen> getArrayItem() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                ItemTruyen ret2 = new ItemTruyen(ret,"chuagiesu");
                arr.add(ret2);
